                        ...
                        <div class="container-fluid">
                            ...
                            <div class="card shadow">
                                <div class="card-header alert-info font-weight-bold">
                                    Halaman Member Perpustakaan
                                </div>
                                <div class="card-body d-flex align-items-center justify-content-center w-100">
                                    <img src="images/card.png" width="80%" alt="card">
                                </div>
                                <div class="text-body text-center mb-4 p-3">
                                    <p class="text-responsive">Selamat Datang Di Halaman Member Perpustakaan<br>
                                        Lorem ipsum dolor sit amet consectetur adipisicing elit<br>
                                        Lorem ipsum, dolor sit amet consectetur adipisicing elit. Officiis, cumque!<br>
