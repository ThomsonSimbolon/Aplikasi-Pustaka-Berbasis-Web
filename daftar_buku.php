                                                ...
                                                ?>
                                                    <tr>
                                                        ...
                                                        <td class="d-flex align-items-center justify-content-between">
                                                            <a href="#" type="button" class="btn-sm btn-custom" data-toggle="modal" data-target="#modalDetail<?php echo $data['isbn']; ?>">
                                                                <span class="fas fa-eye text-info"></span>
                                                            </a>
                                                            <a href="#" type="button" class="btn-sm btn-custom" data-toggle="modal" data-target="#modalEdit<?php echo $data['isbn']; ?>">
                                                                <span class="fas fa-edit text-warning"></span>
                                                            </a>
                                                            <a href="view/hapus_buku.php?isbn=<?php echo $data['isbn'] ?>" class="btn-sm btn-custom">
                                                    ...
                                                    <!-- Modal Detail -->
                                                    <div class="modal fade" id="modalDetail<?php echo $data['isbn']; ?>" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
                                                    ...
                                                    <!-- Modal Edit -->
                                                    <div class="modal fade" id="modalEdit<?php echo $data['isbn'] ?>" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
                                                        <div class="modal-dialog" role="document">
                                                            <div class="modal-content">
                                                                <div class="modal-header bg-gradient-success text-white">
                                                                ...
                                                                <div class="modal-body">
                                                                    <form action="view/edit_buku.php" method="post">
                                                                        <div class="form-group">
                                                                            <label for="judul_buku">Judul Buku</label>
                                                                            <input type="text" name="judul_buku" value="<?= $data['judul_buku'] ?>" class="form-control" id="judul_buku" placeholder="judul buku" required>
                                                                        </div>
                                                                        <div class="form-group">
                                                                        ...
                                                                        <div class="form-group">
                                                                            ...
                                                                            <input type="text" name="penulis" value="<?= $data['penulis'] ?>" class="form-control" id="penulis" placeholder="penulis" required>
                                                                        </div>
                                                                        <div class="form-group">
                                                                            <label for="penerbit">Penerbit</label>
                                                                            <input type="text" name="penerbit" value="<?= $data['penerbit'] ?>" class="form-control" id="penerbit" placeholder="penerbit" required>
                                                                        </div>
                                                                        <div class="form-group">
                                                                            <label for="tahun_terbit">Tahun Terbit</label>
                                                                            <input type="text" name="tahun_terbit" value="<?= $data['tahun_terbit'] ?>" class="form-control" id="tahun_terbit" placeholder="tahun_terbit" required>
                                                                        </div>
                                                                        <div class="form-group">
                                                                        ...
                                                                        <div class="modal-footer">
                                                                            <input type="hidden" name="isbn" id="isbn" value="<?php echo $data['isbn'] ?>">
                                                    ...
                                                    <div class="modal fade" id="modalTambah" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
                                                        <div class="modal-dialog" role="document">
                                                            <div class="modal-content">
                                                                ...
                                                                <div class="modal-body">
                                                                    <form action="view/tambah_buku.php" method="post">
                                                                        <div class="form-group">
                                                                            <label for="judul_buku">Judul Buku</label>
                                                                        ...
                                                                        <div class="form-group">
                                                                            <label for="tahun_terbit">Tahun Terbit</label>
                                                                            <input type="text" name="tahun_terbit" class="form-control" id="tahun_terbit" placeholder="tahun_terbit" required>
                                                                        </div>
                                                                        <div class="form-group">
                                                                            <label for="status">Status</label>
