                        ...
                        <div class="col-lg-12">
                            <div class="card shadow">
                                <div class="card-header bg-gradient-success">
                                    <h5 class="text-white m-0 font-weight-bold text-underline">Laporan Daftar Buku</h5>
                                </div>
                                <div class="card-body">
                                                ...
                                                ?>
                                                    <tr>
                                                        ...
                                                        <td class="d-flex align-items-center justify-content-center">
                                                            <a href="print/print_buku.php?isbn=<?php echo $data['isbn'] ?>" class="btn btn-sm btn-info" target="_blank">
