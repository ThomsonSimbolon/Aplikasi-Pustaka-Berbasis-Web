                        ...
                        <div class="col-lg-12">
                            <div class="card shadow">
                                <div class="card-header bg-gradient-success">
                                    <h5 class="text-white m-0 font-weight-bold text-underline">Laporan Peminjaman</h5>
                                </div>
                                <div class="card-body">
                                                ...
                                                ?>
                                                    <tr>
                                                        ...
                                                        <td class="d-flex align-items-center justify-content-center">
                                                            <a href="print/print_peminjaman.php?id_pinjam=<?php echo $data['id_pinjam'] ?>" class="btn btn-sm btn-info" target="_blank">
